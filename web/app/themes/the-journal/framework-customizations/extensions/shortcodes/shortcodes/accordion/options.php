...
/*
 * Shortcode options which are shown in shortcode popup
 */
	...
	'tabs-group' => array(
		...
		'options' => array(
			'tabs' => array(
				...
				'popup-title'   => esc_html__( 'Add/Edit Tabs', 'the-journal' ),
				'desc'          => esc_html__( 'Add tabs', 'the-journal' ),
				'template'      => '{{=title}}',
				'popup-options' => array(
					'title'   => array(
						'label' => esc_html__( 'Title', 'the-journal' ),
						'desc'  => esc_html__( 'Enter the tab title', 'the-journal' ),
						'type'  => 'text',
						'value' => '',
					),
					'content' => array(
						'label'   => esc_html__( 'Content', 'the-journal' ),
						'desc'    => esc_html__( 'Enter the accordion content', 'the-journal' ),
						'type'    => 'wp-editor',
						'tinymce' => true,
						'reinit'  => true,
						'wpautop' => false,
