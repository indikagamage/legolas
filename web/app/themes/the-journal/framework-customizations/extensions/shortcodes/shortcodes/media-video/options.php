...
$options = array(
	'video'      => array(
		'label' => esc_html__( 'Video', 'the-journal' ),
		'desc'  => esc_html__( 'Enter Youtube or Vimeo video URL', 'the-journal' ),
		'type'  => 'text',
	),
	'width'      => array(
		'label' => esc_html__( 'Width', 'the-journal' ),
		'desc'  => esc_html__( 'Video width in pixels', 'the-journal' ),
		'type'  => 'short-text',
		'value' => '',
	),
	'responsive' => array(
